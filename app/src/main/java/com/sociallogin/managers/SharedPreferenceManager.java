package com.sociallogin.managers;
...
public class SharedPreferenceManager {
    ...
    */
    ...
    public void saveUserModel(UserMeta userMeta)
    {
        if(userMeta ==null)
            return;

        setStringInPreferences(AppConstants.SharedPreferenceKeys.USER_NAME.getKey(), userMeta.userName);
        setStringInPreferences(AppConstants.SharedPreferenceKeys.USER_EMAIL.getKey(), userMeta.userEmail);
        setStringInPreferences(AppConstants.SharedPreferenceKeys.USER_IMAGE_URL.getKey(), userMeta.profilePic);
    }

    public UserMeta getUserModelFromPreferences()
    {
        UserMeta userMeta =null;
        String name = getStringFromPreferances(AppConstants.SharedPreferenceKeys.USER_NAME.getKey());
        if(!TextUtils.isEmpty(name)) {
            userMeta = new UserMeta();
            userMeta.userName = name;
            userMeta.userEmail = getStringFromPreferances(AppConstants.SharedPreferenceKeys.USER_EMAIL.getKey());
            userMeta.profilePic = getStringFromPreferances(AppConstants.SharedPreferenceKeys.USER_IMAGE_URL.getKey());
